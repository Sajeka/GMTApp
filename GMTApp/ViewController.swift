...
//         lineGraphView.setNeedsDisplay()
        ...
        /*
         Bar graph code
         */
        let barChart1: BarChartObj = BarChartObj(barChartPoints: [2500.5,1200.0,7500.0,490.0,730.0], barColor: .red, barChartTitle: "Shoes", lineWidth: 1.0)
        let barChart2: BarChartObj = BarChartObj(barChartPoints: [2000.8,1800.0,500.0,550.0,3000.0], barColor: .blue, barChartTitle: "Bags", lineWidth: 1.0)
        let barChart3: BarChartObj = BarChartObj(barChartPoints: [3000.3,900.0,620.0,5500.0,4700.0], barColor: .green, barChartTitle: "Perfumes", lineWidth: 1.0)

        lineGraphView.setCornerRadius(width: 5.0, height: 5.0)
        lineGraphView.setBorders(topBorder: 50, bottomBorder: 50, leftBorder: 35, rightBorder: 35)

        lineGraphView.setBarChartPoints(barChart: barChart1)
        lineGraphView.setBarChartPoints(barChart: barChart2)
        lineGraphView.setBarChartPoints(barChart: barChart3)

        lineGraphView.setAxes(xAxis: ["Man","Tir","Ons","Tor","Fre"], xAxisFont: nil, yAxisMinValue: 0, yAxisMaxValue: 10000, yAxisNumberOfElements: 6, fontSize: 11, textColor: nil, marginToXAxis: 10, marginToYAxis: 5, yAxisFont: nil)

 ...
 */
        ...
        /*
         Bar graph code
         */
//        let barChart1: BarChartObj = BarChartObj(barChartPoints: [2500.5,1200.0,7500.0,490.0,730.0], barColor: .red, barChartCategory: "Shoes", lineWidth: 1.0)
//        let barChart2: BarChartObj = BarChartObj(barChartPoints: [2000.8,1800.0,500.0,550.0,3000.0], barColor: .blue, barChartCategory: "Bags", lineWidth: 1.0)
//        let barChart3: BarChartObj = BarChartObj(barChartPoints: [3000.3,900.0,620.0,5500.0,4700.0], barColor: .green, barChartCategory: "Perfumes", lineWidth: 1.0)
...
//
//        lineGraphView.createBarChart(barCharts: barChartArray, xAxisStrings: ["Man","Tir","Ons","Tor"], yAxis: yAxis)

...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let graph1: Graph = Graph(graphPoints: [5.0,6.0,5.0,6.0,1.0,6.0,5.0,6.0,5.0,4.0,7.0], graphColor: nil, lineWidth: 5.0, trendLine: nil, animate: true, animationDuration: 5.0)
        ...
        lineGraphView.setAxes(xAxis: ["M","T","S","T","F","W","B"], yAxisMinValue: 0, yAxisMaxValue: 10, yAxisNumberOfElements: 11, fontSize: nil, textColor: nil, marginToXAxis: 5, marginToYAxis: 5)

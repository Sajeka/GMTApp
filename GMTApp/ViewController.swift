...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //                                                     pieChartType: PieChartView.PieChartType.circularBand,
        //                                                     minPercentileTreshHold: 3,
        //                                                     combinedCategoryName: "Other",
        //                                                     combinedCategoryColor: UIColor.darkGray)
        //                lineGraphView.createPieChart(pieChart: pieChart)
        //                lineGraphView.title.graphTitle = "Lagkage diagram"
        //                lineGraphView.borders.addToTopBorder = 5
        //                lineGraphView.setNeedsDisplay()
    }
}
